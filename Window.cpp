...
: wireframeMode(false)
{
	...
	this->GLWindow = glfwCreateWindow(1600, 1200, "FirstProject", NULL, NULL);
	if(GLWindow == NULL)
	{
	...
	glfwSetCursorPosCallback(this->GLWindow, InputManager::mouse_callback);
...
void Window::keyInputCallback(int key, int scancode, int action, int mods)
{
